...
num_clusters = 4
pipe = clusters.get_pipeline_hierarchical(num_clusters)
pipe.fit(data)
_, _, data_pca = clusters.get_pca_data_hierarchical(num_clusters)
data_with_clusters = data
data_with_clusters['predicted_cluster'] = pipe.fit_predict(data)
